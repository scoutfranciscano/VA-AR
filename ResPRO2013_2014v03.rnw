...
an\'alisis de los resultados de este reporte, se presenta un
...
Aporte Relativo institucional s\'olo entre aquellas
...
de cruce entre las pruebas SABER 11$^\text{o}$ y SABER PRO. (Para m\'as informaci\'on ver anexo sobre descripci\'on de los datos del estudio de
Aporte Relativo). Para la conformaci\'on de 
la vecindad de comparaci\'on se parte del \'\i{}ndice SABER 11$^\text{o}$ y se toman 
las instituciones ubicadas a menos de 0.3 desviaciones est\'andar. El listado completo se presenta en el 
Anexo - Resultados de Aporte Relativo para la vecindad extendida. Por motivos de presentaci\'on,
se incluyen un m\'aximo de 15 instituciones durante el informe, las cuales son las m\'as cercanas a la IGR 
al hacer un ejercicio de muestrear 100 veces un 95\% de la poblaci\'on de la IGR y definir la vecindad.
Esto garantiza una mayor estabilidad de la definici\'on de la vecindad de comparaci\'on a 
trav\'es del tiempo. En adelante, cuando se presenten resultados de la vecindad, corresponden a los relacionados con 
esas m\'aximo 15 instituciones. 
