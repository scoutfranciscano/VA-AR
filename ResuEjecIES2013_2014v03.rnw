...
%\documentclass[paperheight=10cm,paperwidth=27cm,margin=1cm]{icfesdocapa}

\documentclass[11pt,doc,babel,spanish,noapacite]{icfesdocapa}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% % Construccion de resúmenes ejecutivos
% %
...
##Aqu\'\i{} va la construcci\'on del grafico 2 que se incluye en el archivo
## "InformesIES.rnw"
...
\LARGE{
\begin{center}
\textbf{Resumen ejecutivo del reporte de resultados en SABER PRO, medidas de Aporte Relativo y
otros indicadores de calidad de las Instituciones de Educaci\'on
Superior 2013-2014\vspace{42mm}}
\end{center}
}
...
if(flag2){
Sweave('REResPRO2013_2014v03.rnw', encoding = "latin1")
    if (flagVA & nComparables > 0) {
      Sweave('REAR2013_2014v01.rnw', encoding = "latin1")
    }
    Sweave('REOCalidad2013_2014v02.rnw', encoding = "latin1")
}
@

<<Armado,results=tex,echo=false>>=
if(flag2){
    cat('\\input{REResPRO2013_2014v03}\n')
    if (flagVA & nComparables > 0) {
      cat('\\input{REAR2013_2014v01}\n')
    }
    cat('\\input{REOCalidad2013_2014v02}\n')
}
@
